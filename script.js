...
const METAL_YEARLY_HISTORY = {
  ...
  gold:{
    CHF: [
      ...
      555.14, 734.63, 822.74, 940.97, 1047.44, 1274.67, 1434.13, 1564.46, 1307.16,
      1158.66, 1134.05, 1233.16, 1240.95, 1242.08, 1369.42, 1670.71, 1645.27,
      1687.84, 1744.25, 2099.82, 2836.23,
    ],
    ...
    GBP: [
      ...
      762.65, 749.54, 923.44, 974.73, 950.44, 1092.04, 1377.25, 1312.94, 1481.34,
      1560.71, 1865.53, 2598.68,
    ],
    ...
    USD: [
      ...
      444.74, 603.46, 695.39, 871.96, 972.35, 1224.53, 1571.52, 1668.98, 1411.23,
      1266.06, 1160.06, 1248.69, 1257.12, 1268.49, 1392.6, 1769.64, 1798.61,
      1800.09, 1940.54, 2386.2, 3431.54,
    ],
...
const chart = new Chart(canvas, {
  type: "line",
  data: {
    labels: METAL_YEARLY_HISTORY.labels,
    datasets: [
      {
        label: "Gold (USD)",
...
function updateChart(metal) {
  ...
  chart.data.labels = METAL_YEARLY_HISTORY.labels;
